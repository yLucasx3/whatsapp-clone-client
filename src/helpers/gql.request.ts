...
export const sendNewMessageAsync = async (
  conversationId: string,
  senderId: string,
  content: string
) =>
...
export const getConversationsListAsync = async () =>
  await mainGqlClient
    .query({
...
export const getConversationDetailsAsync = async (conversationId: string) =>
  await mainGqlClient
    .query({
...
export const getConversationMessagesAsync = async (conversationId: string) =>
  await mainGqlClient
    .query({
